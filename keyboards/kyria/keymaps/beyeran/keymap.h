...
#define NEO2_ROW3_LEFT APB_R31, DE_UDIA, DE_ODIA, DE_ADIA, DE_P,  DE_Z,
...
// Standard
#define STANNI_ROW1_LEFT APB_R11, DE_Q,  DE_W,  DE_E,  DE_R,  DE_T,
#define STANNI_ROW2_LEFT APB_R21, DE_A,  DE_S,  DE_D,  DE_F,  DE_G,
#define STANNI_ROW3_LEFT APB_R31, DE_Z,  DE_X,  DE_C,  DE_V,  DE_B,

#define STANNI_ROW1_RIGHT DE_Y, DE_U,  DE_I,    DE_O,    DE_P,    APB_R1E,
#define STANNI_ROW2_RIGHT DE_H, CTL_J, SF2_K,   ALT_L,   GUI_OE,  XXXXXXX,
#define STANNI_ROW3_RIGHT DE_N, DE_M,  XXXXXXX, XXXXXXX, XXXXXXX, APB_R3E,

#define STANNI_THUMB_ROW1_LEFT DE_UNDS, KC_CAPS,
#define STANNI_THUMB_ROW2_LEFT XXXXXXX, KC_ENT, MO(LOWER),  KC_ENT, KC_TAB,

#define STANNI_THUMB_ROW1_RIGHT MO(ADJUST), KC_CAPS,
#define STANNI_THUMB_ROW2_RIGHT KC_TAB,     KC_SPC, MO(RAISE), KC_ENT, XXXXXXX
...
#define ADJUST_ROW2_LEFT XXXXXXX, TG(BONE),     TG(NEO2), TG(STANNI), XXXXXXX, XXXXXXX,
